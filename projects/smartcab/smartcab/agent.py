...
class LearningAgent(Agent):
	...
	if self.learning == True:
		...
		# Create a dictionary for a particular state
		self.Q[state] = dict()

		# For each valid action (None, forward, right, left) init to 0
		for action in self.valid_actions:
		    self.Q[state][action] = 0.0

	if self.env.verbose == True:
	    print "#######################################"
	    print "Q-learning state are:"
	    print "#######################################"
            print self.Q
	...
	if self.learning == False:
	    ...
	    # If we're learning, choose random action if epsilon > random value between 0 and 1
	    if self.epsilon > random.random():
		print "Epsilon prevails"
		action = random.choice(self.valid_actions)
	    else:
